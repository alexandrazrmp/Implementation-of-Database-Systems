...
typedef struct {
    int Last_id; //Last block id
    int Last_Block_Capacity; //How many records we can add to the last block 
    int Last_Block_entries;
    int Block_size; //How many records we can keep 
    int dirty;
} HP_info;
